        ...
        <>
            <div className="skills">
                ...
                <div className="tag_list">
                    ...
                    <Tag name="Kotlin" text="👨‍💻 I've been utilizing Kotlin (alongside Gradle and Quarkus) with a Postgres database on a daily basis for the past 6 months to build secure, reliable & 
                ...
                <div className="tag_list">
                    ...
                    <Tag name="Flutter" text="🐦 For the 3 months I've been using Flutter on a daily basis to build fast, dynamic & interactive mobile UIs for both iOS and Android. I also have a few personal
