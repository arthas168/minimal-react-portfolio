        ...
        <>
            <div className="skills">
                ...
                <div className="tag_list">
                    ...
                    <Tag name="Python" position={'is_last'} text="🐍 I haven't used Python professionally yet, but I've built several personal projects (some of which are on my GitHub page). I also really want to start using the Django framework for web development."/>
