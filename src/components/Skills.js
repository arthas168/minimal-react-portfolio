        ...
        <>
            <div className="skills">
                ...
                <div className="tag_list">
                    <Tag name="Kotlin" position={'is_first'} text="👨‍💻 I've been utilizing Kotlin (alongside Gradle and Quarkus) with a Postgres database on a daily basis for 7 months while working at TechPods to build secure, reliable & 
                    fast backend microservices."/>
                    <Tag name="Flutter" text="🐦 I've used Flutter everyday for 6 months while working at TechPods to build fast, dynamic & interactive mobile UIs for both iOS and Android. I also have a few personal
