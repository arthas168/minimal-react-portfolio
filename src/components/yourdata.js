export default {
  ...
  //Contact Email
  contactEmail: "pavlovskipetko@gmail.com",

  // Landing Page Name
  landingPageName: "Petko (Pete) Pavlovski",

  // Landing Page Paragraph
  landingPagePara:
    "Full Stack Developer, proficient in Javascript, Kotlin & Flutter. Passionate blockchain advocate. Long history of organising and working with people, thus cultivating strong leadership and teamwork skills.",
